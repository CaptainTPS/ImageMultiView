...
public:
    ...
    {
        SelectChildrenDialog->setWindowTitle(QApplication::translate("SelectChildrenDialog", "Select children by type and/or name", 0));
        groupBox->setTitle(QApplication::translate("SelectChildrenDialog", "Select children...", 0));
        typeCheckBox->setText(QApplication::translate("SelectChildrenDialog", "of type", 0));
        nameCheckBox->setText(QApplication::translate("SelectChildrenDialog", "with name", 0));
        checkBoxRegex->setText(QApplication::translate("SelectChildrenDialog", "regex", 0));
        typeStrictCheckBox->setText(QApplication::translate("SelectChildrenDialog", "strict", 0));
    } // retranslateUi
