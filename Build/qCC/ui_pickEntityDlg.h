...
public:
    ...
    {
        PickEntityDlg->setWindowTitle(QApplication::translate("PickEntityDlg", "Select an entity", 0));
        label->setText(QApplication::translate("PickEntityDlg", "Please select an entity:", 0));
    } // retranslateUi
