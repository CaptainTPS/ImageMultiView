...
public:
    ...
    void setupUi(QDialog *BoundingBoxEditorDialog)
    {
        ...
        xOriXDoubleSpinBox->setMinimum(-1e+09);
        xOriXDoubleSpinBox->setMaximum(1e+09);
        ...
        xOriYDoubleSpinBox->setMinimum(-1e+09);
        xOriYDoubleSpinBox->setMaximum(1e+09);
        ...
        xOriZDoubleSpinBox->setMinimum(-1e+09);
        xOriZDoubleSpinBox->setMaximum(1e+09);
        ...
        yOriXDoubleSpinBox->setMinimum(-1e+09);
        yOriXDoubleSpinBox->setMaximum(1e+09);
        ...
        yOriYDoubleSpinBox->setMinimum(-1e+09);
        yOriYDoubleSpinBox->setMaximum(1e+09);
        ...
        yOriZDoubleSpinBox->setMinimum(-1e+09);
        yOriZDoubleSpinBox->setMaximum(1e+09);
        ...
        zOriXDoubleSpinBox->setMinimum(-1e+09);
        zOriXDoubleSpinBox->setMaximum(1e+09);
        ...
        zOriYDoubleSpinBox->setMinimum(-1e+09);
        zOriYDoubleSpinBox->setMaximum(1e+09);
        ...
        zOriZDoubleSpinBox->setMinimum(-1e+09);
        zOriZDoubleSpinBox->setMaximum(1e+09);
    ...
    {
        BoundingBoxEditorDialog->setWindowTitle(QApplication::translate("BoundingBoxEditorDialog", "Bounding Box Editor", 0));
        pointTypeComboBox->clear();
        pointTypeComboBox->insertItems(0, QStringList()
         << QApplication::translate("BoundingBoxEditorDialog", "Min corner", 0)
         << QApplication::translate("BoundingBoxEditorDialog", "Center", 0)
         << QApplication::translate("BoundingBoxEditorDialog", "Max corner", 0)
        );
        widthComboBox->clear();
        widthComboBox->insertItems(0, QStringList()
         << QApplication::translate("BoundingBoxEditorDialog", "Width", 0)
        );
        xLabel->setText(QApplication::translate("BoundingBoxEditorDialog", "X", 0));
        yLabel->setText(QApplication::translate("BoundingBoxEditorDialog", "Y", 0));
        zLabel->setText(QApplication::translate("BoundingBoxEditorDialog", "Z", 0));
        warningLabel->setText(QApplication::translate("BoundingBoxEditorDialog", "Warning, this box doesn't include the cloud bounding-box!", 0));
        oriGroupBox->setTitle(QApplication::translate("BoundingBoxEditorDialog", "Orientation", 0));
#ifndef QT_NO_TOOLTIP
        oriZCheckBox->setToolTip(QApplication::translate("BoundingBoxEditorDialog", "automatically compute Z if checked", 0));
#endif // QT_NO_TOOLTIP
        oriZCheckBox->setText(QApplication::translate("BoundingBoxEditorDialog", "Z", 0));
#ifndef QT_NO_TOOLTIP
        oriYCheckBox->setToolTip(QApplication::translate("BoundingBoxEditorDialog", "automatically compute Y if checked", 0));
#endif // QT_NO_TOOLTIP
        oriYCheckBox->setText(QApplication::translate("BoundingBoxEditorDialog", "Y", 0));
#ifndef QT_NO_TOOLTIP
        oriXCheckBox->setToolTip(QApplication::translate("BoundingBoxEditorDialog", "automatically compute X if checked", 0));
#endif // QT_NO_TOOLTIP
        oriXCheckBox->setText(QApplication::translate("BoundingBoxEditorDialog", "X", 0));
        keepSquareCheckBox->setText(QApplication::translate("BoundingBoxEditorDialog", "keep square", 0));
        defaultPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "Default", 0));
        lastPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "Last", 0));
        okPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "OK", 0));
        cancelPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "Cancel", 0));
    } // retranslateUi
