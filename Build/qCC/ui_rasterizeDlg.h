...
public:
    ...
    void retranslateUi(QDialog *RasterizeToolDialog)
    {
        ...
        cloudInfoGroupBox->setTitle(QApplication::translate("RasterizeToolDialog", "Cloud", 0));
        label->setText(QApplication::translate("RasterizeToolDialog", "Name", 0));
        cloudNameLabel->setText(QApplication::translate("RasterizeToolDialog", "Unknown", 0));
        label_3->setText(QApplication::translate("RasterizeToolDialog", "Points", 0));
        pointCountLabel->setText(QApplication::translate("RasterizeToolDialog", "0", 0));
        ...
        gridWidthLabel->setText(QApplication::translate("RasterizeToolDialog", "640 x 480", 0));
        ...
        dimensionComboBox->insertItems(0, QStringList()
         << QApplication::translate("RasterizeToolDialog", "X", 0)
         << QApplication::translate("RasterizeToolDialog", "Y", 0)
         << QApplication::translate("RasterizeToolDialog", "Z", 0)
        );
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        interpolateSFCheckBox->setToolTip(QApplication::translate("RasterizeToolDialog", "Interpolate scalar field(s)", 0));
#endif // QT_NO_TOOLTIP
