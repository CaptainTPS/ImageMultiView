...
public:
    ...
    void setupUi(QDialog *FilterByValueDialog)
    {
        ...
        minDoubleSpinBox->setMinimum(-1e+09);
        minDoubleSpinBox->setMaximum(1e+09);
        ...
        maxDoubleSpinBox->setMinimum(-1e+09);
        maxDoubleSpinBox->setMaximum(1e+09);
    ...
    {
        FilterByValueDialog->setWindowTitle(QApplication::translate("FilterByValueDialog", "Filter by value", 0));
        label->setText(QApplication::translate("FilterByValueDialog", "Range", 0));
#ifndef QT_NO_TOOLTIP
        minDoubleSpinBox->setToolTip(QApplication::translate("FilterByValueDialog", "Min range value", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("FilterByValueDialog", "-", 0));
#ifndef QT_NO_TOOLTIP
        maxDoubleSpinBox->setToolTip(QApplication::translate("FilterByValueDialog", "Max range value", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        exportPushButton->setToolTip(QApplication::translate("FilterByValueDialog", "Exports the points falling inside the specified range.", 0));
#endif // QT_NO_TOOLTIP
        exportPushButton->setText(QApplication::translate("FilterByValueDialog", "Export", 0));
#ifndef QT_NO_TOOLTIP
...
"the other with the points falling outside.", 0));
#endif // QT_NO_TOOLTIP
        splitPushButton->setText(QApplication::translate("FilterByValueDialog", "Split", 0));
        cancelPushButton->setText(QApplication::translate("FilterByValueDialog", "Cancel", 0));
    } // retranslateUi
