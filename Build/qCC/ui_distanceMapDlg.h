...
public:
    ...
    void setupUi(QDialog *DistanceMapDialog)
    {
        ...
        marginDoubleSpinBox->setMaximum(1e+06);
        ...
        minDistDoubleSpinBox->setMaximum(1e+09);
        ...
        maxDistDoubleSpinBox->setMaximum(1e+09);
    ...
    {
        DistanceMapDialog->setWindowTitle(QApplication::translate("DistanceMapDialog", "Distance Map", 0));
        label->setText(QApplication::translate("DistanceMapDialog", "Steps", 0));
...
"(but the more points will be created)", 0));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("DistanceMapDialog", "Outer margin", 0));
#ifndef QT_NO_TOOLTIP
        marginDoubleSpinBox->setToolTip(QApplication::translate("DistanceMapDialog", "Margin added around the cloud bounding-box", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        rangeCheckBox->setToolTip(QApplication::translate("DistanceMapDialog", "reduce result to the specified range", 0));
#endif // QT_NO_TOOLTIP
        rangeCheckBox->setText(QApplication::translate("DistanceMapDialog", "Range", 0));
        label_2->setText(QApplication::translate("DistanceMapDialog", "-", 0));
    } // retranslateUi
