...
public:
    ...
    {
        RegistrationDialog->setWindowTitle(QApplication::translate("RegistrationDialog", "Clouds registration", 0));
        groupBox_5->setTitle(QApplication::translate("RegistrationDialog", "Role assignation", 0));
#ifndef QT_NO_TOOLTIP
        label_10->setToolTip(QApplication::translate("RegistrationDialog", "'data' entity", 0));
#endif // QT_NO_TOOLTIP
        label_10->setText(QApplication::translate("RegistrationDialog", "aligned", 0));
#ifndef QT_NO_TOOLTIP
        dataLineEdit->setToolTip(QApplication::translate("RegistrationDialog", "<html><head/><body><p>entity to align (will be displaced)</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        dataLineEdit->setStatusTip(QApplication::translate("RegistrationDialog", "the data cloud is the entity to align with the model cloud : it will be displaced (red cloud)", 0));
#endif // QT_NO_STATUSTIP
        modelColorButton->setText(QString());
        dataColorButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        label_9->setToolTip(QApplication::translate("RegistrationDialog", "'model' entity", 0));
#endif // QT_NO_TOOLTIP
        label_9->setText(QApplication::translate("RegistrationDialog", "reference", 0));
#ifndef QT_NO_TOOLTIP
        modelLineEdit->setToolTip(QApplication::translate("RegistrationDialog", "<html><head/><body><p>reference entity (won't move)</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        modelLineEdit->setStatusTip(QApplication::translate("RegistrationDialog", "the model cloud is the reference : it won't move (yellow cloud)", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_TOOLTIP
        swapButton->setToolTip(QApplication::translate("RegistrationDialog", "press once to exchange model and data clouds", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        swapButton->setStatusTip(QApplication::translate("RegistrationDialog", "press once to exchange model and data clouds", 0));
#endif // QT_NO_STATUSTIP
        swapButton->setText(QApplication::translate("RegistrationDialog", "swap", 0));
#ifndef QT_NO_TOOLTIP
        iterationsCriterion->setToolTip(QApplication::translate("RegistrationDialog", "By choosing this criterion, you can control the computation time.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        iterationsCriterion->setStatusTip(QApplication::translate("RegistrationDialog", "By choosing this criterion, you can control the computation time.", 0));
#endif // QT_NO_STATUSTIP
        iterationsCriterion->setText(QApplication::translate("RegistrationDialog", "Number of iterations", 0));
#ifndef QT_NO_TOOLTIP
        maxIterationCount->setToolTip(QApplication::translate("RegistrationDialog", "Set the maximal number of step for the algorithm regsitration computation .", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        errorCriterion->setToolTip(QApplication::translate("RegistrationDialog", "By choosing this criterion, you can control the quality of the result.", 0));
#endif // QT_NO_TOOLTIP
        errorCriterion->setText(QApplication::translate("RegistrationDialog", "RMS difference", 0));
#ifndef QT_NO_TOOLTIP
        rmsDifferenceLineEdit->setToolTip(QApplication::translate("RegistrationDialog", "Set the minimum RMS improvement between 2 consecutive iterations (below which the registration process will stop).", 0));
#endif // QT_NO_TOOLTIP
        rmsDifferenceLineEdit->setText(QApplication::translate("RegistrationDialog", "1.0e-5", 0));
#ifndef QT_NO_TOOLTIP
        label_4->setToolTip(QApplication::translate("RegistrationDialog", "Rough estimation of the final overlap ratio of the data cloud (the smaller, the better the initial registration should be!)", 0));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("RegistrationDialog", "Final overlap", 0));
#ifndef QT_NO_TOOLTIP
        overlapSpinBox->setToolTip(QApplication::translate("RegistrationDialog", "Rough estimation of the final overlap ratio of the data cloud (the smaller, the better the initial registration should be!)", 0));
#endif // QT_NO_TOOLTIP
        overlapSpinBox->setSuffix(QApplication::translate("RegistrationDialog", "%", 0));
#ifndef QT_NO_STATUSTIP
        adjustScaleCheckBox->setStatusTip(QApplication::translate("RegistrationDialog", "Whether to adjust the scale of the 'data' entity", 0));
#endif // QT_NO_STATUSTIP
        adjustScaleCheckBox->setText(QApplication::translate("RegistrationDialog", "adjust scale", 0));
        label_6->setText(QApplication::translate("RegistrationDialog", "max thread count", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        maxThreadCountSpinBox->setSuffix(QApplication::translate("RegistrationDialog", " / 8", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabStdParams), QApplication::translate("RegistrationDialog", "Parameters", 0));
        label->setText(QApplication::translate("RegistrationDialog", "Random sampling limit", 0));
#ifndef QT_NO_TOOLTIP
        randomSamplingLimitSpinBox->setToolTip(QApplication::translate("RegistrationDialog", "Above this limit, clouds are randomly resampled at each iteration", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("RegistrationDialog", "Rotation", 0));
        rotComboBox->clear();
        rotComboBox->insertItems(0, QStringList()
         << QApplication::translate("RegistrationDialog", "XYZ", 0)
         << QApplication::translate("RegistrationDialog", "X", 0)
         << QApplication::translate("RegistrationDialog", "Y", 0)
         << QApplication::translate("RegistrationDialog", "Z", 0)
        );
        label_3->setText(QApplication::translate("RegistrationDialog", "Translation", 0));
        TxCheckBox->setText(QApplication::translate("RegistrationDialog", "Tx", 0));
        TyCheckBox->setText(QApplication::translate("RegistrationDialog", "Ty", 0));
        TzCheckBox->setText(QApplication::translate("RegistrationDialog", "Tz", 0));
#ifndef QT_NO_TOOLTIP
        pointsRemoval->setToolTip(QApplication::translate("RegistrationDialog", "Chose this option to remove points that are likely to disturb the registration during the computation.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        pointsRemoval->setStatusTip(QApplication::translate("RegistrationDialog", "Chose this option to remove points that are likely to disturb the registration during the computation.", 0));
#endif // QT_NO_STATUSTIP
        pointsRemoval->setText(QApplication::translate("RegistrationDialog", "Enable farthest points removal", 0));
#ifndef QT_NO_TOOLTIP
        checkBoxUseDataSFAsWeights->setToolTip(QApplication::translate("RegistrationDialog", "<html><head/><body><p>Use the displayed scalar field as weights (the bigger its associated scalar value/weight is, the more influence the point will have).</p><p>Note that only absolute distances are considered (i.e. minimal weight is 0).</p><p>Weights are automatically normalized.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        checkBoxUseDataSFAsWeights->setText(QApplication::translate("RegistrationDialog", "Data: use displayed S.F. as weights", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        checkBoxUseModelSFAsWeights->setText(QApplication::translate("RegistrationDialog", "Model: use displayed S.F. as weights (only for clouds)", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabResearchParams), QApplication::translate("RegistrationDialog", "Research", 0));
    } // retranslateUi
