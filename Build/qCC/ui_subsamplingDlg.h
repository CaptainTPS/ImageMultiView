...
public:
    ...
    {
        SubsamplingDialog->setWindowTitle(QApplication::translate("SubsamplingDialog", "Cloud sub sampling", 0));
        mainParamGroupBox->setTitle(QApplication::translate("SubsamplingDialog", "Sampling parameters", 0));
        label_4->setText(QApplication::translate("SubsamplingDialog", "method", 0));
        labelSliderMin->setText(QApplication::translate("SubsamplingDialog", "none", 0));
        labelSliderMax->setText(QApplication::translate("SubsamplingDialog", "all", 0));
#ifndef QT_NO_TOOLTIP
        slider->setToolTip(QApplication::translate("SubsamplingDialog", "The more on the left, the less points will be kept", 0));
#endif // QT_NO_TOOLTIP
        valueLabel->setText(QApplication::translate("SubsamplingDialog", "value", 0));
#ifndef QT_NO_TOOLTIP
        sfGroupBox->setToolTip(QApplication::translate("SubsamplingDialog", "To modulate the sampling distance with a scalar field value", 0));
#endif // QT_NO_TOOLTIP
        sfGroupBox->setTitle(QApplication::translate("SubsamplingDialog", "Use active SF", 0));
        label->setText(QApplication::translate("SubsamplingDialog", "SF value", 0));
        label_2->setText(QApplication::translate("SubsamplingDialog", "Spacing value", 0));
        label_3->setText(QApplication::translate("SubsamplingDialog", "min", 0));
        minSFlabel->setText(QApplication::translate("SubsamplingDialog", "0", 0));
        label_5->setText(QApplication::translate("SubsamplingDialog", "max", 0));
        maxSFlabel->setText(QApplication::translate("SubsamplingDialog", "100", 0));
    } // retranslateUi
