...
public:
    ...
    {
        CurvatureDialog->setWindowTitle(QApplication::translate("CurvatureDialog", "Curvature", 0));
        label_2->setText(QApplication::translate("CurvatureDialog", "Curvature", 0));
        curvatureTypeComboBox->clear();
        curvatureTypeComboBox->insertItems(0, QStringList()
         << QApplication::translate("CurvatureDialog", "Gaussian", 0)
         << QApplication::translate("CurvatureDialog", "Mean", 0)
         << QApplication::translate("CurvatureDialog", "Normal change rate", 0)
        );
        label->setText(QApplication::translate("CurvatureDialog", "kernel", 0));
    } // retranslateUi
