...
public:
    ...
    void retranslateUi(QDialog *NormalComputationDlg)
    {
        ...
        mixedSelectionLabel->setText(QApplication::translate("NormalComputationDlg", "Mixed selection: some clouds don't have scan grid(s)", 0));
...
#ifndef QT_NO_TOOLTIP
        useScanGridRadioButton->setToolTip(QApplication::translate("NormalComputationDlg", "Using scan grid(s) instead of the octree", 0));
#endif // QT_NO_TOOLTIP
        useScanGridRadioButton->setText(QApplication::translate("NormalComputationDlg", "use scan grid(s) whenever possible", 0));
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("NormalComputationDlg", "Each normal will be computed using the (2p+1)*(2p+1) neighbors in the grid", 0));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("NormalComputationDlg", "kernel size", 0));
#ifndef QT_NO_TOOLTIP
        gridKernelSpinBox->setToolTip(QApplication::translate("NormalComputationDlg", "Each normal will be computed using the (2p+1)*(2p+1) neighbors in the grid", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        useOctreeRadioButton->setToolTip(QApplication::translate("NormalComputationDlg", "The octree works for any cloud", 0));
#endif // QT_NO_TOOLTIP
        useOctreeRadioButton->setText(QApplication::translate("NormalComputationDlg", "use octree", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        scanGridsOrientRadioButton->setToolTip(QApplication::translate("NormalComputationDlg", "Using scan grid(s) is the most robust method", 0));
#endif // QT_NO_TOOLTIP
        scanGridsOrientRadioButton->setText(QApplication::translate("NormalComputationDlg", "Use scan grid(s) whenever possible", 0));
#ifndef QT_NO_TOOLTIP
        ...
        preferredOrientationComboBox->insertItems(0, QStringList()
         << QApplication::translate("NormalComputationDlg", "+X", 0)
         << QApplication::translate("NormalComputationDlg", "-X", 0)
         << QApplication::translate("NormalComputationDlg", "+Y", 0)
         << QApplication::translate("NormalComputationDlg", "-Y", 0)
         << QApplication::translate("NormalComputationDlg", "+Z", 0)
         << QApplication::translate("NormalComputationDlg", "-Z", 0)
         << QApplication::translate("NormalComputationDlg", "+Barycenter", 0)
         << QApplication::translate("NormalComputationDlg", "- Barycenter", 0)
         << QApplication::translate("NormalComputationDlg", "+ (0,0,0)", 0)
         << QApplication::translate("NormalComputationDlg", "- (0,0,0)", 0)
         << QApplication::translate("NormalComputationDlg", "Use previous normal", 0)
        );
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        mstNeighborsSpinBox->setPrefix(QApplication::translate("NormalComputationDlg", "knn = ", 0));
    } // retranslateUi
