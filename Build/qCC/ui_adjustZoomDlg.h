...
public:
    ...
    void retranslateUi(QDialog *AdjustZoomDialog)
    {
        ...
        windowLabel->setText(QApplication::translate("AdjustZoomDialog", "1 (800 x 600)", 0));
        label_2->setText(QApplication::translate("AdjustZoomDialog", "zoom", 0));
        ...
        label_4->setText(QApplication::translate("AdjustZoomDialog", "/", 0));
