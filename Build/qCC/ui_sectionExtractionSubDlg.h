...
public:
    ...
    void retranslateUi(QDialog *SectionExtractionSubDlg)
    {
        ...
        activeSectionsLabel->setText(QApplication::translate("SectionExtractionSubDlg", "0", 0));
...
#ifndef QT_NO_TOOLTIP
        extractContoursGroupBox->setToolTip(QApplication::translate("SectionExtractionSubDlg", "To extract the contour of each section as a polyline", 0));
#endif // QT_NO_TOOLTIP
        extractContoursGroupBox->setTitle(QApplication::translate("SectionExtractionSubDlg", "Extract section profile(s)", 0));
...
#ifndef QT_NO_TOOLTIP
        contourTypeComboBox->setToolTip(QApplication::translate("SectionExtractionSubDlg", "Section type (lower or upper part, or both)", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        splitContourCheckBox->setText(QApplication::translate("SectionExtractionSubDlg", "split profile on longer edges", 0));
#ifndef QT_NO_TOOLTIP
