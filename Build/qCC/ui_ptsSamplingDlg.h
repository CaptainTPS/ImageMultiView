...
public:
    ...
    void setupUi(QDialog *PointsSamplingDialog)
    {
        ...
        dDoubleSpinBox->setMaximum(1e+08);
    ...
    {
        PointsSamplingDialog->setWindowTitle(QApplication::translate("PointsSamplingDialog", "Points Sampling on mesh", 0));
#ifndef QT_NO_TOOLTIP
        pnRadioButton->setToolTip(QApplication::translate("PointsSamplingDialog", "Total number of sampled points (approx.)", 0));
#endif // QT_NO_TOOLTIP
        pnRadioButton->setText(QApplication::translate("PointsSamplingDialog", "Points Number", 0));
#ifndef QT_NO_TOOLTIP
        dRadioButton->setToolTip(QApplication::translate("PointsSamplingDialog", "Density: pts/square unit", 0));
#endif // QT_NO_TOOLTIP
        dRadioButton->setText(QApplication::translate("PointsSamplingDialog", "Density", 0));
#ifndef QT_NO_TOOLTIP
        pnSpinBox->setToolTip(QApplication::translate("PointsSamplingDialog", "Total number of sampled points (approx.)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        dDoubleSpinBox->setToolTip(QApplication::translate("PointsSamplingDialog", "Density: pts/square unit", 0));
#endif // QT_NO_TOOLTIP
        normalsCheckBox->setText(QApplication::translate("PointsSamplingDialog", "generate normals", 0));
        label->setText(QApplication::translate("PointsSamplingDialog", "get colors", 0));
        colorsCheckBox->setText(QApplication::translate("PointsSamplingDialog", "from RGB", 0));
        textureCheckBox->setText(QApplication::translate("PointsSamplingDialog", "or from material/texture if available", 0));
    } // retranslateUi
