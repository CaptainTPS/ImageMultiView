...
public:
    ...
    {
        SFEditDlg->setWindowTitle(QApplication::translate("SFEditDlg", "SF Values", 0));
        dispLabel->setText(QApplication::translate("SFEditDlg", "displayed", 0));
        satLabel->setText(QApplication::translate("SFEditDlg", "saturation", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("SFEditDlg", "Display ranges", 0));
#ifndef QT_NO_TOOLTIP
        nanInGreyCheckBox->setToolTip(QApplication::translate("SFEditDlg", "hidden otherwise...", 0));
#endif // QT_NO_TOOLTIP
        nanInGreyCheckBox->setText(QApplication::translate("SFEditDlg", "show NaN/out of range values in grey", 0));
        alwaysShow0CheckBox->setText(QApplication::translate("SFEditDlg", "always show 0 in color scale", 0));
        symmetricalScaleCheckBox->setText(QApplication::translate("SFEditDlg", "symmetrical color scale", 0));
        logScaleCheckBox->setText(QApplication::translate("SFEditDlg", "log scale", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("SFEditDlg", "Parameters", 0));
    } // retranslateUi
