...
public:
    ...
    void retranslateUi(QDialog *VolumeCalcDialog)
    {
...
#endif // QT_NO_TOOLTIP
        gridWidthLabel->setText(QApplication::translate("VolumeCalcDialog", "640 x 480", 0));
        ...
        projDimComboBox->insertItems(0, QStringList()
         << QApplication::translate("VolumeCalcDialog", "X", 0)
         << QApplication::translate("VolumeCalcDialog", "Y", 0)
         << QApplication::translate("VolumeCalcDialog", "Z", 0)
        );
#ifndef QT_NO_TOOLTIP
