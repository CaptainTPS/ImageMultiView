...
public:
    ...
    void retranslateUi(QDialog *ComparisonDialog)
    {
        ...
        preciseGroupBox->setTitle(QApplication::translate("ComparisonDialog", "Precise results", 0));
...
#endif // QT_NO_TOOLTIP
        maxThreadCountSpinBox->setSuffix(QApplication::translate("ComparisonDialog", " / 8", 0));
...
"to help you set the general parameters", 0));
        histoButton->setText(QApplication::translate("ComparisonDialog", "...", 0));
        preciseResultsTabWidget->setTabText(preciseResultsTabWidget->indexOf(approxTab), QApplication::translate("ComparisonDialog", "Approx. results", 0));
