...
public:
    ...
    {
        RenderToFileDialog->setWindowTitle(QApplication::translate("RenderToFileDialog", "Render to file", 0));
        label->setText(QApplication::translate("RenderToFileDialog", "Filename", 0));
        chooseFileButton->setText(QApplication::translate("RenderToFileDialog", "...", 0));
        label_2->setText(QApplication::translate("RenderToFileDialog", "Zoom", 0));
        label_3->setText(QApplication::translate("RenderToFileDialog", "Result:", 0));
        finalSizeLabel->setText(QApplication::translate("RenderToFileDialog", "(? x ?)", 0));
        dontScaleFeaturesCheckBox->setText(QApplication::translate("RenderToFileDialog", "Don't scale features (e.g. points size, lines thickness, text, etc.)", 0));
        renderOverlayItemsCheckBox->setText(QApplication::translate("RenderToFileDialog", "Render overlay items (scale, trihedron, etc.)", 0));
    } // retranslateUi
