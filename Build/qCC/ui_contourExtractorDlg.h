...
public:
    ...
    {
        ContourExtractorDlg->setWindowTitle(QApplication::translate("ContourExtractorDlg", "Contour Extractor Visual Debug", 0));
        label->setText(QApplication::translate("ContourExtractorDlg", "Message", 0));
        messageLabel->setText(QApplication::translate("ContourExtractorDlg", "no message", 0));
        autoCheckBox->setText(QApplication::translate("ContourExtractorDlg", "auto", 0));
        nextPushButton->setText(QApplication::translate("ContourExtractorDlg", "Next", 0));
        skipPushButton->setText(QApplication::translate("ContourExtractorDlg", "Skip", 0));
    } // retranslateUi
