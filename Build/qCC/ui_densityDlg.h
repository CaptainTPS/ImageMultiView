...
public:
    ...
    {
        DensityDialog->setWindowTitle(QApplication::translate("DensityDialog", "Cloud Density", 0));
        groupBox->setTitle(QApplication::translate("DensityDialog", "Method", 0));
#ifndef QT_NO_TOOLTIP
        preciseRadioButton->setToolTip(QApplication::translate("DensityDialog", "Compute the density by determining the number of neighbors inside a sphere of given radius around each point", 0));
#endif // QT_NO_TOOLTIP
        preciseRadioButton->setText(QApplication::translate("DensityDialog", "Precise", 0));
        label->setText(QApplication::translate("DensityDialog", "radius", 0));
#ifndef QT_NO_TOOLTIP
        radiusDoubleSpinBox->setToolTip(QApplication::translate("DensityDialog", "Neighborhood sphere radius", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        approxRadioButton->setToolTip(QApplication::translate("DensityDialog", "Estimate the density by computing the distance to the nearest neighbor (much faster but less accurate)", 0));
#endif // QT_NO_TOOLTIP
        approxRadioButton->setText(QApplication::translate("DensityDialog", "Approximate", 0));
        groupBox_2->setTitle(QApplication::translate("DensityDialog", "Output", 0));
#ifndef QT_NO_TOOLTIP
        knnRadioButton->setToolTip(QApplication::translate("DensityDialog", "Simply returns the number of neighbors", 0));
#endif // QT_NO_TOOLTIP
        knnRadioButton->setText(QApplication::translate("DensityDialog", "Number of neighbors", 0));
#ifndef QT_NO_TOOLTIP
        surfRadioButton->setToolTip(QApplication::translate("DensityDialog", "Output the surface density (neighborhood is admitted to always be flat)", 0));
#endif // QT_NO_TOOLTIP
        surfRadioButton->setText(QApplication::translate("DensityDialog", "Surface density", 0));
#ifndef QT_NO_TOOLTIP
        volRadioButton->setToolTip(QApplication::translate("DensityDialog", "Output the volume density (3D)", 0));
#endif // QT_NO_TOOLTIP
        volRadioButton->setText(QApplication::translate("DensityDialog", "Volume density", 0));
    } // retranslateUi
