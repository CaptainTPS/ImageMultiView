...
public:
    ...
    void setupUi(QDialog *DisplayOptionsDlg)
    {
        ...
        pageColorAndMatOptions->setGeometry(QRect(0, 0, 471, 278));
        ...
        pageSFOptions->setGeometry(QRect(0, 0, 433, 107));
        ...
        pageLabelsOptions->setGeometry(QRect(0, 0, 336, 111));
        ...
        pageOtherOptions->setGeometry(QRect(0, 0, 431, 262));
    ...
    {
        DisplayOptionsDlg->setWindowTitle(QApplication::translate("DisplayOptionsDlg", "Display options", 0));
        sunLightGroup->setTitle(QApplication::translate("DisplayOptionsDlg", "Light", 0));
        ambientColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_3->setText(QApplication::translate("DisplayOptionsDlg", "Ambient", 0));
        specularColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_4->setText(QApplication::translate("DisplayOptionsDlg", "Specular", 0));
        diffuseColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_5->setText(QApplication::translate("DisplayOptionsDlg", "Diffuse", 0));
#ifndef QT_NO_TOOLTIP
        doubleSidedCheckBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "<html><head/><body><p>Whether to use a double-sided light model or not</p><p>(if disabled, triangles will appear black when looked from behind)</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        doubleSidedCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "double-sided", 0));
        sunLightGroup_2->setTitle(QApplication::translate("DisplayOptionsDlg", "Default Materials", 0));
        meshFrontColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_6->setText(QApplication::translate("DisplayOptionsDlg", "Mesh Front", 0));
        meshBackColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_7->setText(QApplication::translate("DisplayOptionsDlg", "Mesh Back", 0));
        meshSpecularColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_12->setText(QApplication::translate("DisplayOptionsDlg", "Mesh specular", 0));
        pointsColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_8->setText(QApplication::translate("DisplayOptionsDlg", "Points", 0));
        othersGroup->setTitle(QApplication::translate("DisplayOptionsDlg", "Colors", 0));
        bkgColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_2->setText(QApplication::translate("DisplayOptionsDlg", "Background", 0));
        bbColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_9->setText(QApplication::translate("DisplayOptionsDlg", "Bounding-box", 0));
        textColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label->setText(QApplication::translate("DisplayOptionsDlg", "Text", 0));
#ifndef QT_NO_TOOLTIP
        enableGradientCheckBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Gradient goes from 'background' color to inverse of 'Points' color", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        enableGradientCheckBox->setStatusTip(QApplication::translate("DisplayOptionsDlg", "Gradient goes from 'background' color to inverse of 'Points' color", 0));
#endif // QT_NO_STATUSTIP
        enableGradientCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "display gradient background", 0));
        toolBox->setItemText(toolBox->indexOf(pageColorAndMatOptions), QApplication::translate("DisplayOptionsDlg", "Colors and Materials", 0));
        colorScaleShowHistogramCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Show histogram next to color ramp", 0));
        useColorScaleShaderCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Enable shader for faster display (ATI cards: use at your own risk ;)", 0));
        label_10->setText(QApplication::translate("DisplayOptionsDlg", "Ramp width", 0));
        colorRampWidthSpinBox->setSuffix(QApplication::translate("DisplayOptionsDlg", " pixels", 0));
        toolBox->setItemText(toolBox->indexOf(pageSFOptions), QApplication::translate("DisplayOptionsDlg", "Color scale (scalar field)", 0));
        label_13->setText(QApplication::translate("DisplayOptionsDlg", "Label opacity", 0));
        labelOpacitySpinBox->setSuffix(QApplication::translate("DisplayOptionsDlg", "%", 0));
        label_16->setText(QApplication::translate("DisplayOptionsDlg", "Label font size", 0));
        label_20->setText(QApplication::translate("DisplayOptionsDlg", "background color", 0));
        labelBkgColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        label_15->setText(QApplication::translate("DisplayOptionsDlg", "Labels marker size", 0));
        label_18->setText(QApplication::translate("DisplayOptionsDlg", "marker color", 0));
        labelMarkerColorButton->setText(QApplication::translate("DisplayOptionsDlg", "...", 0));
        toolBox->setItemText(toolBox->indexOf(pageLabelsOptions), QApplication::translate("DisplayOptionsDlg", "Labels", 0));
        label_11->setText(QApplication::translate("DisplayOptionsDlg", "Default font size", 0));
        label_14->setText(QApplication::translate("DisplayOptionsDlg", "Displayed numbers precision", 0));
        label_17->setText(QApplication::translate("DisplayOptionsDlg", "Perspective zooming speed", 0));
#ifndef QT_NO_TOOLTIP
        zoomSpeedDoubleSpinBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Zoom/walk speed in perspective mode (default = 1.0)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        decimateCloudBox->setStatusTip(QApplication::translate("DisplayOptionsDlg", "Automatically decimate big point clouds when moved", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        decimateCloudBox->setWhatsThis(QApplication::translate("DisplayOptionsDlg", "Automatically decimate big point clouds when moved", 0));
#endif // QT_NO_WHATSTHIS
        decimateCloudBox->setText(QApplication::translate("DisplayOptionsDlg", "Decimate clouds over", 0));
#ifndef QT_NO_TOOLTIP
        maxCloudSizeDoubleSpinBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Minimum number of points to activate decimation", 0));
#endif // QT_NO_TOOLTIP
        maxCloudSizeDoubleSpinBox->setPrefix(QApplication::translate("DisplayOptionsDlg", "> ", 0));
        maxCloudSizeDoubleSpinBox->setSuffix(QApplication::translate("DisplayOptionsDlg", " M.", 0));
        label_21->setText(QApplication::translate("DisplayOptionsDlg", "points when moved", 0));
#ifndef QT_NO_STATUSTIP
        decimateMeshBox->setStatusTip(QApplication::translate("DisplayOptionsDlg", "Automatically decimate big meshes when moved", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        decimateMeshBox->setWhatsThis(QApplication::translate("DisplayOptionsDlg", "Automatically decimate big meshes when moved", 0));
#endif // QT_NO_WHATSTHIS
        decimateMeshBox->setText(QApplication::translate("DisplayOptionsDlg", "Decimate meshes over", 0));
#ifndef QT_NO_TOOLTIP
        maxMeshSizeDoubleSpinBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Minimum number of triangles to activate decimation", 0));
#endif // QT_NO_TOOLTIP
        maxMeshSizeDoubleSpinBox->setPrefix(QApplication::translate("DisplayOptionsDlg", "> ", 0));
        maxMeshSizeDoubleSpinBox->setSuffix(QApplication::translate("DisplayOptionsDlg", " M.", 0));
        label_19->setText(QApplication::translate("DisplayOptionsDlg", "triangles when moved", 0));
        useVBOCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Try to load clouds on GPU for faster display", 0));
#ifndef QT_NO_TOOLTIP
        showCrossCheckBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "A cross is displayed in the middle of the screen", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        showCrossCheckBox->setStatusTip(QApplication::translate("DisplayOptionsDlg", "A cross is displayed in the middle of the screen", 0));
#endif // QT_NO_STATUSTIP
        showCrossCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Show middle screen cross", 0));
        label_22->setText(QApplication::translate("DisplayOptionsDlg", "Auto-compute octree for picking", 0));
        autoComputeOctreeComboBox->clear();
        autoComputeOctreeComboBox->insertItems(0, QStringList()
         << QApplication::translate("DisplayOptionsDlg", "Always", 0)
         << QApplication::translate("DisplayOptionsDlg", "Ask each time", 0)
         << QApplication::translate("DisplayOptionsDlg", "Never", 0)
        );
#ifndef QT_NO_TOOLTIP
        autoComputeOctreeComboBox->setToolTip(QApplication::translate("DisplayOptionsDlg", "Octree computation can be long but the picking is then much faster", 0));
#endif // QT_NO_TOOLTIP
        toolBox->setItemText(toolBox->indexOf(pageOtherOptions), QApplication::translate("DisplayOptionsDlg", "Other options", 0));
        okButton->setText(QApplication::translate("DisplayOptionsDlg", "Ok", 0));
        applyButton->setText(QApplication::translate("DisplayOptionsDlg", "Apply", 0));
        resetButton->setText(QApplication::translate("DisplayOptionsDlg", "Reset", 0));
        cancelButton->setText(QApplication::translate("DisplayOptionsDlg", "Cancel", 0));
    } // retranslateUi
