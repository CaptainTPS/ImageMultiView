...
public:
    ...
    {
        GlobalShiftAndScaleDlg->setWindowTitle(QApplication::translate("GlobalShiftAndScaleDlg", "Global shift/scale", 0));
        messageLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Coordinates are too big (original precision may be lost)!", 0));
#ifndef QT_NO_TOOLTIP
        moreInfoToolButton->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "More information about this issue", 0));
#endif // QT_NO_TOOLTIP
        moreInfoToolButton->setText(QApplication::translate("GlobalShiftAndScaleDlg", "?", 0));
        label_4->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Do you wish to translate/rescale the entity?", 0));
        infoLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "shift/scale information is stored and used to restore the original coordinates at export time", 0));
#ifndef QT_NO_TOOLTIP
        bigCubeFrame->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "This version corresponds to the input (or output) file", 0));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Point in original\n"
"coordinate system (on disk)", 0));
        xOriginLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "x = 3213132123.3215", 0));
        yOriginLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "y = 3213213143.34", 0));
        zOriginLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "z = 3.87", 0));
        diagOriginLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "diagonal = 3213132123.3215", 0));
        label_3->setText(QApplication::translate("GlobalShiftAndScaleDlg", "x", 0));
        label1->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Shift", 0));
        label_5->setText(QApplication::translate("GlobalShiftAndScaleDlg", "+", 0));
        label1_2->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Scale", 0));
#ifndef QT_NO_TOOLTIP
        loadComboBox->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "You can add default items to this list by placing a text file named <span style=\" font-weight:600;\">global_shift_list.txt</span> next to the application executable file. On each line you should define 5 items seperated by semicolon characters: name ; ShiftX ; ShiftY ; ShiftZ ; scale", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        smallCubeFrame->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "This version is the one CloudCompare will work with. Mind the digits!", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Point in local\n"
"coordinate system", 0));
        xDestLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "x = 123.3215", 0));
        yDestLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "y = 143.34", 0));
        zDestLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "z = 3.87", 0));
        diagDestLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "diagonal = 321313", 0));
        warningLabel->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Warning: previously used shift and/or scale don't seem adapted to this entity", 0));
#ifndef QT_NO_TOOLTIP
        keepGlobalPosCheckBox->setToolTip(QApplication::translate("GlobalShiftAndScaleDlg", "The local coordinates will be changed so as to keep the global coordinates the same", 0));
#endif // QT_NO_TOOLTIP
        keepGlobalPosCheckBox->setText(QApplication::translate("GlobalShiftAndScaleDlg", "Keep original position fixed", 0));
    } // retranslateUi
