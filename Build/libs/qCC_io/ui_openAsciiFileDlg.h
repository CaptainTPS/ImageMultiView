...
public:
    ...
    void retranslateUi(QDialog *AsciiOpenDialog)
    {
        ...
        label_3->setText(QApplication::translate("AsciiOpenDialog", "Filename:", 0));
        label->setText(QApplication::translate("AsciiOpenDialog", "Here are the first lines of this file. Choose each column attribution (one cloud at a time):", 0));
        ...
        toolButtonShortcutESP->setText(QApplication::translate("AsciiOpenDialog", "ESP", 0));
        toolButtonShortcutTAB->setText(QApplication::translate("AsciiOpenDialog", "TAB", 0));
        toolButtonShortcutComma->setText(QApplication::translate("AsciiOpenDialog", ",", 0));
        toolButtonShortcutDotcomma->setText(QApplication::translate("AsciiOpenDialog", ";", 0));
