...
public:
    ...
    {
        OpenLASFileDialog->setWindowTitle(QApplication::translate("OpenLASFileDialog", "Open LAS File", 0));
        redCheckBox->setText(QApplication::translate("OpenLASFileDialog", "R", 0));
        greenCheckBox->setText(QApplication::translate("OpenLASFileDialog", "G", 0));
        blueCheckBox->setText(QApplication::translate("OpenLASFileDialog", "B", 0));
        classifCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Classification", 0));
        decomposeClassifGroupBox->setTitle(QApplication::translate("OpenLASFileDialog", "decompose", 0));
        classifValueCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Value", 0));
        classifSyntheticCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Synthetic flag", 0));
        classifKeypointCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Key-point", 0));
        classifWithheldCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Withheld", 0));
        timeCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Time", 0));
        pointSourceIDCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Point source ID", 0));
        numberOfReturnsCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Number of returns", 0));
        returnNumberCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Return number", 0));
        scanDirFlagCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Scan direction flag", 0));
        edgeOfFlightCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Edge of flight line", 0));
        scanAngleRankCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Scan angle rank", 0));
        userDataCheckBox->setText(QApplication::translate("OpenLASFileDialog", "User data", 0));
        intensityCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Intensity", 0));
        tabWidget->setTabText(tabWidget->indexOf(stdTab), QApplication::translate("OpenLASFileDialog", "Standard fields", 0));
        extraFieldGroupBox->setTitle(QApplication::translate("OpenLASFileDialog", "Load additional field(s)", 0));
        tabWidget->setTabText(tabWidget->indexOf(extTab), QApplication::translate("OpenLASFileDialog", "Extended fields", 0));
        tileGroupBox->setTitle(QApplication::translate("OpenLASFileDialog", "Tile input file", 0));
        label_4->setText(QApplication::translate("OpenLASFileDialog", "Dimension", 0));
        tileDimComboBox->clear();
        tileDimComboBox->insertItems(0, QStringList()
         << QApplication::translate("OpenLASFileDialog", "XY", 0)
         << QApplication::translate("OpenLASFileDialog", "XZ", 0)
         << QApplication::translate("OpenLASFileDialog", "YZ", 0)
        );
        label_5->setText(QApplication::translate("OpenLASFileDialog", "Tiles", 0));
        label_6->setText(QApplication::translate("OpenLASFileDialog", "x", 0));
        label->setText(QApplication::translate("OpenLASFileDialog", "Output path", 0));
        browseToolButton->setText(QApplication::translate("OpenLASFileDialog", "...", 0));
        label_7->setText(QApplication::translate("OpenLASFileDialog", "Warning: the cloud won't be loaded in memory.\n"
"It will be saved as multiple tiles on the disk.", 0));
        tabWidget->setTabText(tabWidget->indexOf(tilingTab), QApplication::translate("OpenLASFileDialog", "Tiling", 0));
        label_2->setText(QApplication::translate("OpenLASFileDialog", "Points", 0));
        label_3->setText(QApplication::translate("OpenLASFileDialog", "Bounding-box", 0));
        tabWidget->setTabText(tabWidget->indexOf(infoTab), QApplication::translate("OpenLASFileDialog", "Info", 0));
        ignoreDefaultFieldsCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Ignore fields with default values only", 0));
#ifndef QT_NO_TOOLTIP
        force8bitRgbCheckBox->setToolTip(QApplication::translate("OpenLASFileDialog", "Force reading colors as 8-bit values (even if the standard is 16-bit)", 0));
#endif // QT_NO_TOOLTIP
        force8bitRgbCheckBox->setText(QApplication::translate("OpenLASFileDialog", "Force 8-bit colors", 0));
        applyButton->setText(QApplication::translate("OpenLASFileDialog", "Apply", 0));
        applyAllButton->setText(QApplication::translate("OpenLASFileDialog", "Apply all", 0));
        cancelButton->setText(QApplication::translate("OpenLASFileDialog", "Cancel", 0));
    } // retranslateUi
