...
public:
    ...
    {
        SaveLASFileDialog->setWindowTitle(QApplication::translate("SaveLASFileDialog", "LAS/LAZ scale", 0));
        label->setText(QApplication::translate("SaveLASFileDialog", "Choose the output LAS/LAZ scale/resolution:", 0));
        bestRadioButton->setText(QApplication::translate("SaveLASFileDialog", "Highest resolution", 0));
        bestAccuracyLabel->setText(QApplication::translate("SaveLASFileDialog", "(0,0,0)", 0));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("SaveLASFileDialog", "Ensures optimal accuracy (up to 10^-7 absolute)", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("SaveLASFileDialog", "will decrease LAZ compression efficiency", 0));
        origRadioButton->setText(QApplication::translate("SaveLASFileDialog", "Original resolution", 0));
        origAccuracyLabel->setText(QApplication::translate("SaveLASFileDialog", "(0,0,0)", 0));
        label_4->setText(QApplication::translate("SaveLASFileDialog", "might not preserve data accuracy\n"
"(especially if you have transformed the original data)", 0));
        customRadioButton->setText(QApplication::translate("SaveLASFileDialog", "Custom resolution", 0));
        label_3->setText(QApplication::translate("SaveLASFileDialog", "bigger scale = best LAZ compression = lower resolution(*)", 0));
        label_5->setText(QApplication::translate("SaveLASFileDialog", "(*) careful, if chosen too low coordinates will loose accuracy", 0));
    } // retranslateUi
